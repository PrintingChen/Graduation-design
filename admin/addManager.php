...
<div class="admin">
    <div class="panel admin-panel">
        <div class="panel-head"><strong><span class="fa fa-plus-square-o"></span> 添加管理员</strong></div>
        <div class="body-content">
            <form id="addman-form">
                ...
                <div class="form-group" style="overflow: hidden;">
                    <div class="info">权限：</div>
                    <div class="field">
                    </div>
                        <input type="radio" name="power" id="power0" value="0" checked="checked"><label for="power0">普通管理员</label>
                        <input type="radio" name="power" id="power1" value="1"><label for="power1">超级管理员</label>
                </div>
                <div class="form-group" style="overflow: hidden;">
                    <div class="info"><label for=""></label></div>
                    <div class="field">
                        <button type="button" id="addManBtn" class="btn btn-info btn-custom"><i class="fa fa-check-square-o custom"></i>提交</button>
                    </div>
                </div>
            </form>
        </div>
