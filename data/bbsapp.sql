...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-12-06 06:52:43
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(1, '欢迎来到猿学社区， 这里集中了前端以及后端的各种语言提供程序猿的交流天地。');
...
(2, '后端开发', 44, '后端开发是数据库操作和管理'),
(3, '网站SEO', 29, 'SEO是指在了解搜索引擎自然排名机制的基础之上，对网站进行内部及外部的调整优化'),
(8, 'Python', 44, 'PythonPythonPython');
...
(3, 'CSS的margin用法', '<h3>\n	<span style="color:#9933E5;font-family:arial;font-size:13px;background-color:#FFFFFF;">margin是值外边距</span> \n</h3>', '2016-11-16 21:16:03', 5, 55, 11, 0, 0, 0, '2016-11-29 12:08:10', 0),
(13, 'Node服务端', 'Node服务端Node服务端Node服务端', '2016-11-16 21:32:53', 20, 64, 11, 0, 1, 0, '2016-11-24 23:27:51', 0),
(14, 'ajax()的用法详解', 'ajax()的用法详解ajax()的用法详解ajax()的用法详解ajax()的用法详解', '2016-11-16 21:34:12', 9, 88, 11, 0, 1, 0, '2016-11-23 18:42:30', 1),
(15, 'SEO优化的步骤', 'SEO优化的步骤SEO优化的步骤SEO优化的步骤', '2016-11-16 21:37:16', 4, 92, 11, 0, 0, 0, '2016-11-23 15:52:24', 0),
(16, 'vue社区', 'vue社区vue社区vue社区。', '2016-11-16 21:45:04', 11, 10, 15, 0, 0, 0, '2016-11-21 15:36:38', 0),
(18, '栅格布局', '栅格布局栅格布局栅格布局栅格布局', '2016-10-18 12:25:10', 10, 26, 8, 0, 0, 0, '2016-12-06 03:54:39', 0),
(20, 'vue是国人开发的吗', '                            vue是国人开发的vue是国人开发的vue是国人开发的                        ', '2016-11-17 19:10:08', 11, 28, 10, 0, 0, 0, '2016-11-20 16:00:34', 1),
(23, 'iframe关于滚动条的去除和保留', '<span style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:16px;background-color:#FEFEF2;">iframe嵌入页面后，我们有时需要调整滚动条，例如，去掉全部的滚动条，去掉右边的滚动条且保留底下的滚动条，去掉底下的滚动条且保留右边的滚动条。那么我们应该怎么做呢？</span>', '2016-11-18 11:59:08', 1, 107, 14, 0, 1, 0, '0000-00-00 00:00:00', 0),
(24, ' 【CSS3动画】transform对文字及图片的旋转、缩放、倾斜和移动', '<span style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;font-size:13px;">之前我有写过CSS3的</span><strong><span style="color:;">transform</span></strong><span style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;font-size:13px;">这一这特性，对于它的用法，还不是很透彻，今天补充补充，呵呵 你懂的，小司机准备开车了。</span>', '2016-11-18 12:20:58', 5, 105, 14, 0, 0, 0, '2016-11-29 12:08:29', 0),
(25, 'bootstrap是什么', '                            <span style="color:#333333;font-family:"font-size:18px;background-color:#FFFFFF;"> bootstrap引用了部分html元素，所以头部需写成下面所示的样列。</span>                        ', '2016-11-18 12:27:24', 10, 263, 14, 0, 0, 0, '2016-12-03 15:30:17', 0),
(26, ' JSON字符串和js对象转换', '$.parseJSON()和JSON.parse()函数用于将格式完好的JSON字符串转为与之对应的JavaScript对象', '2016-11-18 12:34:45', 6, 100, 8, 0, 0, 0, '2016-11-24 23:19:28', 0),
(27, '五种方式获取文件扩展名-转载未验证', '<span style="font-family:Verdana, Arial, Helvetica, sans-serif;background-color:#FFFFFF;">在PHP面试中，经常碰到此题 ：要求写出5种以上的方法，获取一个文件的扩展名，其实也是在考察面试者基础知识的掌握程度</span>', '2016-11-18 13:15:59', 2, 119, 8, 0, 1, 0, '2016-11-24 11:42:23', 1),
(35, '关于面向对象----继承', '<span style="color:#337FE5;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:16px;background-color:#FFFFFF;">先说说继承是什么吧？也许我们最早接触有关继承的应该是“遗产”？？也许电视剧看多了，总有家族为了这玩意儿整的你死我活，确实听看不下去的哈，但是对于咱大JS而言，可就变得十分和蔼，可亲。毕竟没有人来争夺，也不会有任何事故，最多来些许bug等等。废话不多说，进入正题！！</span>', '2016-11-23 15:40:05', 6, 92, 11, 0, 1, 0, '2016-11-24 14:32:57', 0),
(36, 'HTML5标签', '<p style="font-family:verdana, Arial, helvetica, sans-seriff;background-color:#FFFFFF;">\n	<span style="color:#0000FF;font-size:16px;">不允许写结束标记的标签</span><span style="font-size:16px;">：area(定义图像映射中的区域)、base(为页面上的所有链接规定默认地址或默认目标)、br、col(为表格中一个或多个列定义属性值)、embed(定义嵌入的内容，比如插件--5)、hr、img、input、keygen、link、meta、param、source、track、wbr</span> \n</p>\n<p style="font-family:verdana, Arial, helvetica, sans-seriff;background-color:#FFFFFF;">\n	<span style="font-size:16px;"><span><span style="font-family:verdana, Arial, helvetica, sans-seriff;color:#0000FF;font-size:16px;">不允许写结束标记的标签</span><span style="font-family:verdana, Arial, helvetica, sans-seriff;font-size:16px;">：area(定义图像映射中的区域)、base(为页面上的所有链接规定默认地址或默认目标)、br、col(为表格中一个或多个列定义属性值)、embed(定义嵌入的内容，比如插件--5)、hr、img、input、keygen、link、meta、param、source、track、wbr J-B</span></span></span> \n</p>', '2016-11-23 17:21:41', 1, 265, 2, 0, 1, 0, '2016-11-29 15:48:19', 0),
(37, 'Kendo Grid editing 自定义验证报错提示', '<span style="font-size:16px;color:#CC33E5;">Kendo UI是一个强大的框架用于快速HTML5 UI开发。基于最新的HTML5、CSS3和JavaScript标准。</span><br />\n<span style="font-size:16px;color:#CC33E5;">Kendo UI包含了开发现代JavaScript开发所需要的所有一切，包括：强大的数据源，通用的拖拉（Drag-and-Drop）功能，模板，和UI控件。</span><br />', '2016-11-23 18:31:03', 9, 320, 2, 0, 1, 0, '2016-12-05 14:31:08', 0),
(47, '为什么需要socket.io？', '<span style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;font-size:16px;color:#4C33E5;">node.js提供了高效的服务端运行环境，但是由于浏览器端对</span><span style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;font-size:16px;text-decoration:underline;color:#4C33E5;">HTML5</span><span style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;font-size:16px;color:#4C33E5;">的支持不一，为了兼容所有浏览器，提供卓越的实时的用户体验，并且为程序员提供客户端与服务端一致的编程体验，于是socket.io诞生。</span>', '2016-11-29 16:06:21', 20, 64, 34, 0, 1, 0, '2016-11-30 19:28:50', 0),
(48, 'fsdfdsf', 'sdfsdafads', '2016-11-30 20:37:28', 7, 92, 15, 0, 0, 0, '0000-00-00 00:00:00', 0),
(49, '都是非常V字下次v', '的沙发上的放松的方式打工收入该', '2016-12-04 10:37:10', 6, 21, 29, 0, 0, 0, '0000-00-00 00:00:00', 0),
(50, 'XML基础', '<span style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;font-size:18px;color:#337FE5;">XML（Extensible Markup Language），</span><span style="font-family:宋体;font-size:18px;color:#337FE5;">即可扩展的标记语言</span><span style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;font-size:18px;color:#337FE5;">，</span><span style="font-size:18px;font-family:宋体;color:#337FE5;">它是</span><span style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif;font-size:18px;color:#337FE5;">&nbsp;SGML</span><span style="font-size:18px;font-family:宋体;color:#337FE5;">（标准通用标记语言）的一个子集，xml文件的主要作用是在于作为程序的配置文件来时用</span><span style="font-size:13px;background-color:#28557E;font-family:宋体;"><span style="background-color:;"><span style="color:#337FE5;font-size:18px;"></span><span style="color:#337FE5;font-size:18px;"></span></span></span>', '2016-12-04 10:58:10', 5, 71, 15, 0, 0, 0, '0000-00-00 00:00:00', 0),
(51, '对象的this引用', '<p style="color:#494949;font-family:Arial, Helvetica, sans-serif;font-size:14px;">\r\n	<span style="font-size:15px;">Java中的this关键字总是指向调用该方法的对象。根据this出现位置的不同，this作为对象的默认引用有两个功能：</span>\r\n</p>\r\n<p style="color:#494949;font-family:Arial, Helvetica, sans-serif;font-size:14px;">\r\n	<span style="font-size:15px;">1.构造器中引用该构造器正在初始化的对象。</span>\r\n</p>\r\n<p style="color:#494949;font-family:Arial, Helvetica, sans-serif;font-size:14px;">\r\n	<span style="font-size:15px;">2.在方法中引用调用该方法的对象。</span>\r\n</p>', '2016-12-04 16:39:37', 7, 8, 44, 0, 0, 0, '0000-00-00 00:00:00', 0),
(52, '撒的发生的发生', '第三方地方撒旦飞洒的地方', '2016-12-05 16:39:57', 4, 14, 2, 0, 0, 0, '2016-12-05 14:51:30', 0),
(53, 'redux middleware 的理解', '<span style="color:#003399;font-family:Verdana, Arial, sans-serif, &quot;font-size:24px;background-color:#D6D3D6;">这几天看了redux middleware的运用与实现原理，写了一个百度搜索的demo，实现了类似redux-thunk和redux-logger中间件的功能。</span>', '2016-12-05 21:27:51', 6, 52, 44, 0, 0, 0, '2016-12-05 14:41:45', 0);
...
(101, 37, 90, 2, '都是放松的方式短发说的分手答复是对方的事', '2016-12-03 15:29:09'),
(102, 25, 0, 2, '的说法的萨芬', '2016-12-03 15:30:17'),
(103, 37, 0, 2, 'sfdfs', '2016-12-03 17:05:44'),
(104, 37, 0, 2, '564546', '2016-12-03 17:10:27'),
(105, 37, 90, 2, 'J-B', '2016-12-04 09:59:02'),
(106, 37, 0, 44, '是打发士大夫撒旦飞洒地方事发的', '2016-12-05 21:31:08'),
(107, 53, 0, 44, 'kjgjkjkg', '2016-12-05 21:41:45'),
(108, 52, 0, 44, 'dzgdfgdfgdf', '2016-12-05 21:51:30'),
(109, 18, 0, 2, 'fgdfgfdgdfgdfg', '2016-12-06 10:54:39');
...
CREATE TABLE IF NOT EXISTS `sensitivewords` (
  ...
  `tomid` int(11) NOT NULL COMMENT '操作者id',
  PRIMARY KEY (`swid`)
...
INSERT INTO `sensitivewords` (`swid`, `words`, `tomid`) VALUES
(1, '反共', 1),
(4, 'TMD', 1),
(7, '泥煤', 8),
(12, 'JB', 8),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `loginTimes` int(11) NOT NULL DEFAULT '1' COMMENT '登陆次数',
  PRIMARY KEY (`id`)
...
INSERT INTO `user` (`id`, `name`, `psw`, `sex`, `email`, `qq`, `photo`, `userType`, `reallyName`, `birthday`, `homeplace`, `bloodType`, `fixedTel`, `phone`, `website`, `school`, `degree`, `company`, `profession`, `job`, `income`, `registerTime`, `lastLogin`, `userStatus`, `isForbid`, `loginTimes`) VALUES
(2, 'admin', '9cbf8a4dcb8e30682b927f352d6559a0', '', '2663251638@qq.com', '2663251638', 'uploads/2016/11/10/2448085824251a7b86f760611800.jpg', 0, '李四', '1966-1-27', '福建省、南平市、松溪县', 'B', '0778-3124265', '13264467325', 'http://www.1233.com', '北京大学', '', '阿里巴巴', 'IT', '经理', '3000000', '2016-11-02 00:00:00', '2016-12-06 03:31:34', 0, 0, 4),
(3, 'admin1', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '1', '2663251638@qq.com', '78956416', 'uploads/2016/11/22/760279583445b2e3d89724471208.jpg', 0, 'admin01', '1997-11-20', '未填写', '未填写', '0778-3124265', '13264467325', 'http://www.1233.com', '河池学院', '', '阿里巴巴', 'IT', '程序猿', '100000', '2016-11-02 00:00:00', '2016-11-22 20:04:08', 0, 0, 1),
(4, '李四', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '', '2663251638@qq.com', '2663251638', '', 0, 'admin11', '1997-11-20', '未填写', '未填写', '0778-3124265', '13264467325', 'http://www.1233.com', '科技大学', '本科', '阿里巴巴', 'IT', '经理', '3000000', '2016-11-02 00:00:00', '2016-12-06 03:55:38', 0, 0, 2),
(7, 'admin3', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '', '2663251638@qq.com', '2663251638', 'uploads/2016/11/20/46535658310186e81ae448582964.jpg', 0, 'admin1', '1983-3-3', '河北省、唐山市、古冶区', 'O', '0778-3124265', '13264467325', 'http://www.1233.com', '科技大学', '硕士', '阿里巴巴', 'IT', '经理', '3000000', '2016-11-02 21:51:12', '2016-11-20 10:10:15', 0, 0, 1),
(8, 'MrStay', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '1', '2663251638@qq.com', '2663251638', 'uploads/2016/11/05/136308581d929778a3b656082866.jpg', 0, 'admin111', '1981-3-30', '河南省、驻马店市、古吕镇', 'AB', '0778-3124265', '13264467325', 'http://www.1233.com', '科技大学', '硕士', '阿里巴巴', 'IT', '经理', '3000000', '2016-11-05 15:50:23', '2016-11-20 10:55:55', 0, 0, 1),
(10, '胡歌', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '保密', '2663251638@qq.com', '11671356', '', 0, 'admin111', '--', '省份、城市、县/区/镇', '未填写', '0778-3124265', '13264467325', 'http://www.6794cd.com', '北京电影学院', '本科', '阿里巴巴', 'IT', '经理', '3000000', '0000-00-00 00:00:00', '2016-11-30 13:01:23', 0, 0, 1),
(11, '王宝强', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '', '2663251638@qq.com', '2663251638', 'uploads/2016/11/17/118356582d876838cfb903985235.jpg', 0, 'admin111', '1997-11-20', '未填写', '未填写', '0778-3124265', '13264467325', 'http://www.1233.com', '科技大学', '', '阿里巴巴', 'IT', '经理', '3000000', '0000-00-00 00:00:00', '2016-11-29 13:00:43', 0, 0, 1),
(14, '阿伦-克拉布', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '1', '2663251638@qq.com', '2663251638', '', 1, 'admin111', '1997-11-20', '未填写', '未填写', '0778-3124265', '13264467325', 'http://www.1233.com', '科技大学', '硕士', '阿里巴巴', 'IT', '经理', '3000000', '0000-00-00 00:00:00', '2016-11-18 11:56:52', 0, 0, 1),
(15, 'angle', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '保密', '1076023927@qq.com', '未填写', 'uploads/2016/11/16/321942582c628c32631394923074.jpg', 0, 'baby', '2001-1-16', '山东省、莱芜市、莱城区', 'B', '未填写', '未填写', 'http://', '未填写', '未填写', '未填写', '未填写', '未填写', '未填写', '0000-00-00 00:00:00', '2016-12-04 10:48:34', 0, 0, 1),
(16, 'baby', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '', '1239085@qq.com', '未填写', '', 0, '未填写', '1985-11-13', '未填写', '未填写', '未填写', '未填写', 'http://', '未填写', '本科', '未填写', '未填写', '未填写', '未填写', '2016-11-16 21:52:15', '2016-11-24 10:46:55', 0, 0, 1),
(29, '韦德', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '1', '2584480035@qq.com', '1216763458', '', 1, '韦德', '1982-4-15', '河南省、驻马店市、古吕镇', 'O', '0778-3142625', '13297733516', 'http://www.13456.com', '未填写', '博士', '百度', 'IT', 'php工程师', '300000', '2016-11-17 08:51:20', '2016-12-04 10:36:33', 0, 0, 1),
(30, 'James', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '未填写', '3584480035@qq.com', '未填写', '', 0, '未填写', '未填写', '未填写', '未填写', '未填写', '未填写', 'http://', '未填写', '未填写', '未填写', '未填写', '未填写', '未填写', '2016-11-17 09:01:34', '2016-11-24 19:35:56', 0, 0, 1),
(32, '小马哥', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '男', 'xiaomage@qq.com', '46576631', '', 0, '马健', '1991-2-15', '湖北省、随州市、曾都区', 'O', '0771-3166522', '15878913651', 'http://www.xmg.com', '广州大学', '硕士', '网易', '互联网', '产品经理', '50000000', '0000-00-00 00:00:00', '2016-12-06 02:51:28', 0, 0, 2),
(33, '无名', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '男', '119384257@qq.com', '未填写', '', 0, '未填写', '1991-3-13', '江西省、九江市、都昌县', 'B', '未填写', '未填写', 'http://', '未填写', '未填写', '未填写', '未填写', '未填写', '未填写', '2016-11-29 15:43:27', '2016-11-29 16:29:54', 0, 0, 1),
(34, '无邪', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '1', '13546362@qq.com', '未填写', '', 0, '天真无邪', '未填写', '未填写', '未填写', '未填写', '未填写', 'http://', '未填写', '', '未填写', '未填写', '未填写', '未填写', '2016-11-29 15:47:25', '2016-11-29 15:47:25', 0, 0, 1),
(44, '牛大宝', '49dec5fb8af4eeef7c95e7f5c66c8ae6', '男', '123456465@qq.com', '未填写', '', 1, '未填写', '--', '省份、城市、县/区/镇', '未填写', '未填写', '未填写', 'http://', '未填写', '未填写', '未填写', '未填写', '未填写', '未填写', '2016-12-04 15:14:04', '2016-12-06 03:56:32', 0, 0, 3);
